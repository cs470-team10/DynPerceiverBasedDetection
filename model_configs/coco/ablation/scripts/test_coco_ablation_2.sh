...
test_config theta_factor_115e-4-distribution-1 ${IMPROVEMENT_CHECKPOINT}
test_config theta_factor_115e-4-distribution-2 ${IMPROVEMENT_CHECKPOINT}
test_config theta_factor_115e-4-distribution-3 ${IMPROVEMENT_CHECKPOINT}
test_config theta_factor_115e-4-distribution-4 ${IMPROVEMENT_CHECKPOINT}